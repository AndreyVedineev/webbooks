# Generated by Django 4.2.11 on 2024-04-20 09:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Введите фото автора', null=True, upload_to='images')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('year', models.CharField(help_text='Введите год изздания', max_length=4, verbose_name='Год издания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите жанр книги', max_length=200, verbose_name='Жанар книги')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите нименование издательсва', max_length=20, verbose_name='Издательство')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status')),
            ],
            options={
                'ordering': ['due_back'],
            },
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(help_text='Выбереье язык книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.language', verbose_name='Язык книги'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
